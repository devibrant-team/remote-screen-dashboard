...
import ReservedScheduleScreen from "./ReservedScheduleScreen";

type TabKey = "normal" | "interactive";

const ReservedScheduleToolbar: React.FC = () => {
  ...
  return (
    <div className="h-full min-h-0 flex flex-col space-y-3">
      ...
      <div className="scrollbar-hide overscroll-contain">
        <ReservedScheduleScreen />
      </div>
    </div>
  );
};

export default ReservedScheduleToolbar;
