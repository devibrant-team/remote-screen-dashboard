...
export const DeleteReservedBlockApi= `${http}deleteschedule`
export const PostScheduleItem= `${http}postscheduleitem`
export const GetScheduleItem= `${http}getscheduleitem`
...
export const RefreshScreenApi = `${http}screenrefresh`
